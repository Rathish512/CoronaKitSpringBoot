...
public class AppStartUpEventHandler {
	...
	public void onAppStartup(ApplicationReadyEvent event) {
		if(!userRepo.existsByUsername("Admin")) {
			userRepo.save(new Users("Admin", "admin",penc.encode("admin"),true,"admin@gmail.com","8752362165" , "ADMIN"));
		}
		
		if(!userRepo.existsByUsername("First")) {
			userRepo.save(new Users("First", "abc",penc.encode("abc"),true,"First@gmail.com","9852364178" , "USER"));
		}
		if(!userRepo.existsByUsername("Second")) {
			userRepo.save(new Users("Second", "abc",penc.encode("abc"),true,"Second@gmail.com","9741258963" , "USER"));
		}
	}
}